  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      <div className="text-center space-y-1">
        <h3 className="text-xl font-bold text-white tracking-tight">Instagram Post Preview</h3>
        <p className="text-xs text-zinc-400">
          This is how your post will appear to your Instagram followers.
        </p>
      </div>

      {/* Realistic Phone Frame / Instagram Post Card UI */}
      <div className="rounded-[2.5rem] border-4 border-zinc-800 bg-[#1a1a1a] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] overflow-hidden backdrop-blur-md">
        {/* Post Header */}
        <div className="flex items-center justify-between p-3.5 border-b border-white/5 bg-[#0f0f0f]/90">
          <div className="flex items-center space-x-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-amber-500 to-amber-600 p-0.5 shadow">
              <div className="w-full h-full rounded-full bg-[#0f0f0f] flex items-center justify-center font-bold text-amber-400 text-xs">
                🥐
              </div>
            </div>
            <div>
              <div className="flex items-center space-x-1">
                <span className="font-bold text-xs text-white">{igUsername}</span>
                <ShieldCheck className="w-3.5 h-3.5 text-amber-400 fill-amber-400/20" />
              </div>
              <span className="text-[11px] text-zinc-400 block">{restaurantTitle}</span>
            </div>
          </div>
          <MoreHorizontal className="w-5 h-5 text-zinc-400 cursor-pointer hover:text-white transition" />
        </div>

        {/* Post Square Image Canvas */}
        <div className="relative aspect-square w-full bg-[#0f0f0f] overflow-hidden flex justify-center items-center">
        ...
        <div className="p-4 space-y-3 bg-[#1a1a1a]">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Heart className="w-5 h-5 text-rose-500 fill-rose-500/20 cursor-pointer hover:scale-110 transition" />
              <MessageCircle className="w-5 h-5 text-zinc-300 cursor-pointer hover:scale-110 transition" />
              <Send className="w-5 h-5 text-zinc-300 cursor-pointer hover:scale-110 transition" />
            </div>
            <Bookmark className="w-5 h-5 text-zinc-300 cursor-pointer hover:scale-110 transition" />
          </div>
          ...
          <div className="text-xs text-zinc-200 leading-relaxed space-y-1.5">
            ...
            {hashtagsText && (
              <p className="text-amber-400 font-semibold tracking-tight break-words">
                {hashtagsText}
              </p>
            )}
          </div>
      ...
      <div className="grid grid-cols-2 gap-4 pt-2">
        <button
          ...
          className="py-3.5 px-6 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 font-bold rounded-xl border border-white/10 transition flex items-center justify-center space-x-2 text-xs sm:text-sm shadow-xl disabled:opacity-50"
        >
        ...
        <button
          ...
          disabled={isExporting}
          className="py-3.5 px-6 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 hover:shadow-[0_0_20px_rgba(245,158,11,0.4)] text-zinc-950 font-bold rounded-xl shadow-xl transition-all duration-300 flex items-center justify-center space-x-2 text-xs sm:text-sm disabled:opacity-50"
        >
          {isExporting ? (
